...
class CommentScreenState extends State<CommentScreen> {
  ...
  bool isMediaPosts() {
    final childrenPosts =
        Provider
            .of<PostVM>(context, listen: false)
            .amityPost
            .children;
...
class CommentComponent extends StatefulWidget {
  const CommentComponent({Key? key,
    required this.postId,
    required this.theme,
    required this.feedType})
      : super(key: key);
