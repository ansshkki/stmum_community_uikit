...
class HyperlinkInitialState extends HyperlinkState {
  const HyperlinkInitialState({HyperLink? hyperLink})
      : super(hyperLink: hyperLink);

  @override
  List<Object?> get props => [hyperLink, identityHashCode(this)];
...
class HyperlinkErrorState extends HyperlinkState {
  ...
  const HyperlinkErrorState(
      {HyperLink? hyperLink, this.urlError, this.customizedError})
      : super(hyperLink: hyperLink);

  @override
  List<Object?> get props =>
      [hyperLink, urlError, customizedError, identityHashCode(this)];
